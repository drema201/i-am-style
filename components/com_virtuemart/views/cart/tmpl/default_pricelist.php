...
<div class="billto-shipto">
	<div class="width50 floatleft">
		...
		<span class="vmicon"><span class="vmicon vm2-billto-icon"></span>
	...
	<div class="width50 floatleft">
		...
		<span class="vmicon"><span class="vmicon vm2-shipto-icon"></span>
...
<table
	...
	width="100%">
<tr>
	<th align="left" style="width: 240px"><?php echo JText::_ ('COM_VIRTUEMART_CART_NAME') ?></th>
	<th align="center" style="width: 100px"><?php echo JText::_ ('COM_VIRTUEMART_CART_SKU') ?></th>
	<th align="center" style="width: 100px"><?php echo JText::_ ('COM_VIRTUEMART_CART_PRICE') ?></th>
	<th align="center" style="width: 115px">Количество</th>

	<?php if (VmConfig::get ('show_tax')) { ?>
		<th align="right" style="60px"><?php  echo "<span  class='priceColor2'>" . JText::_ ('COM_VIRTUEMART_CART_SUBTOTAL_TAX_AMOUNT') . '</span>' ?></th>
	<?php } ?>
	
	<th align="right" style="width: 100px"><?php echo "<span  class='priceColor2'>" . JText::_ ('COM_VIRTUEMART_CART_SUBTOTAL_DISCOUNT_AMOUNT') . '</span>' ?></th>
	<th align="right" style="width: 100px"><?php echo JText::_ ('COM_VIRTUEMART_CART_TOTAL') ?></th>
</tr>
...
//				$step=$prow->min_order_level;
			...
			<div style="float: left;">
				...
				<input style="float: left; margin-right: 2px;" type="text" onblur="check<?php echo $step?>(this);" onclick="check<?php echo $step?>(this);" onchange="check<?php echo $step?>(this);" onsubmit="check<?php echo $step?>(this);" title="<?php echo  JText::_('COM_VIRTUEMART_CART_UPDATE') ?>" class="quantity-input js-recalculate" size="3" maxlength="4" name="quantity[<?php echo $prow->cart_item_id ?>]" value="<?php echo $prow->quantity ?>" />
				<input style="font-size: 18px;" type="submit" class="vmicon vm2-add_quantity_cart" name="update[<?php echo $prow->cart_item_id ?>]" title="<?php echo  JText::_ ('COM_VIRTUEMART_CART_UPDATE') ?>" align="middle" value="Обновить"/>
			</div>
			<a class="vmicon vm2-remove_from_cart remove_ico" title="<?php echo JText::_ ('COM_VIRTUEMART_CART_DELETE') ?>" align="middle" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=cart&task=delete&cart_virtuemart_product_id=' . $prow->cart_item_id) ?>" rel="nofollow">Х</a>
	</td>
